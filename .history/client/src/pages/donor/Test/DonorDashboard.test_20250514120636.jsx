...
describe("DonorDashboard", () => {
  ...
  test("adds and removes charity from favorites", async () => {
    ...
    const favButton = firstCard.querySelector(
      "button.favorite-button, button.favorite"
    );
    ...
    const removeFavButton = favCard.querySelector(
      "button.favorite-button, button.favorite"
    );
  ...
  test("shows error message on fetch failure", async () => {
    ...
    renderWithProviders();
    expect(
      await screen.findByText(/Failed to load charities/i)
    ).toBeInTheDocument();
  });
});
